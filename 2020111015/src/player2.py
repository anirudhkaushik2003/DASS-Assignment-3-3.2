...
from queen_arrow import QueenArrow
...
class Player2:
    def __init__(self, character, x, y, color=""):
        ...
        self.move_dict = {1: (1, 0), -1: (-1, 0), 2: (0, -1), -2: (0, 1)}
    ...
    def use_attack(self):
        if self.attack_sequence == False:
            ...
            print("\a")
            if self.direction == 1:
                qarrow = QueenArrow(queenarrow,self.rect.x+self.rect.width,self.midpoint[1],40,self.move_dict[self.last_move_direction][0],self.move_dict[self.last_move_direction][1],conf.SHELL_COLOR)
            elif self.direction == -1:
                qarrow = QueenArrow(queenarrow,self.rect.x - 6,self.midpoint[1],40,self.move_dict[self.last_move_direction][0],self.move_dict[self.last_move_direction][1],conf.SHELL_COLOR)

            queen_arrow_group.add(qarrow)
    ...
    def use_leviathan_axe(self):
        if self.leviathan_sequence == False:
            ...
            print("\a")
            if self.direction == 1:
                qarrow = QueenArrow(queenarrow,self.rect.x+self.rect.width,self.midpoint[1],64,self.move_dict[self.last_move_direction][0],self.move_dict[self.last_move_direction][1],conf.SHELL_COLOR)
            elif self.direction == -1:
                qarrow = QueenArrow(queenarrow,self.rect.x - 6,self.midpoint[1],64,self.move_dict[self.last_move_direction][0],self.move_dict[self.last_move_direction][1],conf.SHELL_COLOR)
